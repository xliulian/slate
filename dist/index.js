...
var normalizeDOMPoint = function normalizeDOMPoint(domPoint) {
  ...
  if (isDOMElement(node) && node.childNodes.length) {
    ...
    idx = _getEditableChildAndI2[1];
    // If the editable child found is in front of our domPoint, we instead seek to its end
...
var withReact = function withReact(editor) {
  ...
  e.insertData = function (data) {
    ...
    if (text) {
      ...
      var _iterator3 = _createForOfIteratorHelper$1(lines),
          _step3;
