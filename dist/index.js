...
var MemoizedElement = /*#__PURE__*/React__default['default'].memo(Element, function (prev, next) {
  return prev.decorate === next.decorate && prev.element === next.element && prev.renderElement === next.renderElement && prev.renderLeaf === next.renderLeaf && isRangeListEqual$1(prev.decorations, next.decorations) && (prev.selection === next.selection || !!prev.selection && !!next.selection && slate.Range.equals(prev.selection, next.selection));
});
/**
...
var Children = function Children(props) {
  ...
  var nodeChildren = isLeafBlock || !node.childrenOrderedBy ? node.children.map(function (child, idx) {
    return [child, idx];
  }) : sortBy__default['default'](node.children, node.childrenOrderedBy).map(function (child) {
...
var normalizeDOMPoint = function normalizeDOMPoint(domPoint) {
  ...
  if (isDOMElement(node) && node.childNodes.length) {
    ...
    var _getEditableChildAndI2 = slicedToArray(_getEditableChildAndI, 2);
...
var getEditableChild = function getEditableChild(parent, index, direction) {
  var _getEditableChildAndI3 = getEditableChildAndIndex(parent, index, direction),
      _getEditableChildAndI4 = slicedToArray(_getEditableChildAndI3, 1),
...
var Editable = function Editable(props) {
  var autoFocus = props.autoFocus,
      ...
      attributes = objectWithoutProperties(props, ["autoFocus", "decorate", "onDOMBeforeInput", "placeholder", "readOnly", "renderElement", "renderLeaf", "scrollSelectionIntoView", "style", "as"]);
