    ...
    addMark: function addMark(key, value) {
      ...
      if (selection) {
        if (Range.isExpanded(selection)) {
          ...
          var marks = _objectSpread(_objectSpread({}, Editor.marks(editor) || {}), {}, defineProperty({}, key, value));
  ...
  extractProps: function extractProps(node) {
    if (Element.isAncestor(node)) {
      var children = node.children,
          properties = objectWithoutProperties(node, ["children"]);

      return properties;
    } else {
      var text = node.text,
          _properties = objectWithoutProperties(node, ["text"]);
  ...
  isPath: function isPath(value) {
    if (Array.isArray(value) && (value.length === 0 || typeof value[0] === 'number')) {
      if (value.length > 0 && typeof value[value.length - 1] !== 'number') {
        throw new Error("Invalid path [".concat(value, "]"));
      }
      ...
      case 'split_node':
        {
          ...
          if (Text.isText(_node6)) {
            ...
            newNode = _objectSpread$6(_objectSpread$6(_objectSpread$6({}, _node6), properties), {}, {
              text: _after2
            });
          } else {
...
var SelectionTransforms = {
  ...
  setPoint: function setPoint(editor, props) {
    ...
    Transforms.setSelection(editor, defineProperty({}, edge === 'anchor' ? 'anchor' : 'focus', _objectSpread$8(_objectSpread$8({}, point), props)));
  },
