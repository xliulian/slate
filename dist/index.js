...
var Element = function Element(props) {
  ...
  var children = /*#__PURE__*/React__default['default'].createElement(Children, {
...
var Editable = function Editable(props) {
  var autoFocus = props.autoFocus,
      ...
      attributes = _objectWithoutProperties(props, ["autoFocus", "decorate", "onDOMBeforeInput", "placeholder", "readOnly", "renderElement", "renderLeaf", "scrollSelectionIntoView", "style", "as"]);
  ...
  useIsomorphicLayoutEffect(function () {
    ...
    if (hasDomSelection && hasDomSelectionInEditor && selection && (isDOMText(domSelection.anchorNode) || domSelection.anchorNode instanceof HTMLElement && domSelection.anchorNode.dataset.slateNode === 'text') && (isDOMText(domSelection.focusNode) || domSelection.focusNode instanceof HTMLElement && domSelection.focusNode.dataset.slateNode === 'text') && slate.Range.equals(ReactEditor.toSlateRange(editor, domSelection), selection)) {
      return;
