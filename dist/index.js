...
var Editable = function Editable(props) {
  ...
  useIsomorphicLayoutEffect(function () {
    ...
    if (hasDomSelection && hasDomSelectionInEditor && selection && isDOMText(domSelection.anchorNode) && isDOMText(domSelection.focusNode) && slate.Range.equals(ReactEditor.toSlateRange(editor, domSelection), selection)) {
      return;
