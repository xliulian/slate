...
var normalizeDOMPoint = domPoint => {
  ...
  if (isDOMElement(node) && node.childNodes.length) {
    ...
    var idx;
    [node, idx] = getEditableChildAndIndex(node, index, isLast ? 'backward' : 'forward'); // If the editable child found is in front of our domPoint, we instead seek to its end

    isLast = idx < index; // If the node has children, traverse until we have a leaf node. Leaf nodes
