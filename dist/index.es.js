...
var Element = props => {
  ...
  var children = /*#__PURE__*/React.createElement(Children, {
...
var Editable = props => {
  ...
  useIsomorphicLayoutEffect(() => {
    ...
    if (hasDomSelection && hasDomSelectionInEditor && selection && (isDOMText(domSelection.anchorNode) || domSelection.anchorNode instanceof HTMLElement && domSelection.anchorNode.dataset.slateNode === 'text') && (isDOMText(domSelection.focusNode) || domSelection.focusNode instanceof HTMLElement && domSelection.focusNode.dataset.slateNode === 'text') && Range.equals(ReactEditor.toSlateRange(editor, domSelection), selection)) {
      return;
