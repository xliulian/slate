...
var Children = props => {
  ...
  var nodeChildren = isLeafBlock || !node.childrenOrderedBy ? node.children.map((child, idx) => [child, idx]) : sortBy(node.children, node.childrenOrderedBy).map(child => [child, node.children.indexOf(child)]);
