...
var Editable = props => {
  var {
    ...
    as: Component = 'div'
      ...
      attributes = _objectWithoutProperties(props, ["autoFocus", "decorate", "onDOMBeforeInput", "placeholder", "readOnly", "renderElement", "renderLeaf", "scrollToSelection", "style", "as"]);
...
var EditorContext$1 = /*#__PURE__*/createContext(null);
/**
 * Get the current editor object from the React context.
 */

var useEditor = () => {
  var editor = useContext(EditorContext$1);
