...
var Editable = props => {
  ...
  useIsomorphicLayoutEffect(() => {
    ...
    if (hasDomSelection && hasDomSelectionInEditor && selection && isDOMText(domSelection.anchorNode) && isDOMText(domSelection.focusNode) && Range.equals(ReactEditor.toSlateRange(editor, domSelection), selection)) {
      return;
