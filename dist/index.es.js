...
var Editable = props => {
  ...
  useIsomorphicLayoutEffect(() => {
    var _domSelection$anchorN, _domSelection$focusNo;
    ...
    if (hasDomSelection && hasDomSelectionInEditor && selection && Range.equals(ReactEditor.toSlateRange(editor, domSelection), selection) && ((_domSelection$anchorN = domSelection.anchorNode) === null || _domSelection$anchorN === void 0 ? void 0 : _domSelection$anchorN.nodeType) === 3 && ((_domSelection$focusNo = domSelection.focusNode) === null || _domSelection$focusNo === void 0 ? void 0 : _domSelection$focusNo.nodeType) === 3) {
      return;
